...
public class RingBuffer<T> {
    ...
    public T this[long index] {
        get { return _entries[index & _modMask]; }
        set {
            unchecked { _entries[index & _modMask] = value; }
        }
    }
...
public static class Volatile {
    ...
    [StructLayout(LayoutKind.Explicit, Size = CacheLineSize*2)] public struct PaddedLong {
        ...
        /// </summary>
        /// <returns>The current value</returns>
        [MethodImpl(MethodImplOptions.NoOptimization)] public long ReadCompilerOnlyFence() {
            return _value;
        }
        ...
        /// </summary>
        /// <param name="newValue">The new value</param>
        [MethodImpl(MethodImplOptions.NoOptimization)] public void WriteCompilerOnlyFence(long newValue) {
            _value = newValue;
        }
