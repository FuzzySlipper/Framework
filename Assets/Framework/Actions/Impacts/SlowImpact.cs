...
namespace PixelComrades {
    [System.Serializable]
    public class SlowImpact : IActionImpact {
        ...
        public SlowImpact(float chance, float length) {
            _chance = chance;
            _length = length;
        }
        ...
        public void ProcessImpact(CollisionEvent collisionEvent, ActionStateEvent stateEvent) {
            ...
            collisionEvent.Target.Post(new SlowEvent(collisionEvent.Target, _length, true));
        }

        public SlowImpact(SerializationInfo info, StreamingContext context) {
